...
var AtMessage = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtMessage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtMessage.__proto__ || Object.getPrototypeOf(AtMessage)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "message", "isOpened", "type", "duration", "__fn_on", "className", "customStyle"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtMessage, [{
    ...
    value: function bindMessageListener() {
      ...
      _index2.default.eventCenter.on('atMessage', function () {
        ...
        _this2.setState(options, function () {
          clearTimeout(_this2._timer);
          _this2._timer = setTimeout(function () {
            _this2.setState({
              isOpened: false
            });
          }, _this2.state.duration);
        });
      });
      // 绑定函数
